...
public enum UnidadeFederativaEnum {
	...
	/**
	   ...
	   */
	  UnidadeFederativaEnum(final String nome, final String sigla, final String capital) {
	    this.nome = nome;
	    this.sigla = sigla;
	 ...
	 */
	public static UnidadeFederativaEnum fromUF(final String nomeUf) {
		for (final UnidadeFederativaEnum uf : UnidadeFederativaEnum.values()) {
	...
	/*
	 * Retorna lista de String com a sigla das unidades
	 */
	public static List<String> listaSiglaUnidades(){
		List<String> listUnidades = new ArrayList<String>();
	
		for (final UnidadeFederativaEnum uf : UnidadeFederativaEnum.values()) {
			listUnidades.add(uf.sigla);
		}
	...
	/*
	 * Retorna lista de String com o nome das unidades
	 */
	public static List<String> listaNomeUnidades(){
		List<String> listUnidades = new ArrayList<String>();
	
		for (final UnidadeFederativaEnum uf : UnidadeFederativaEnum.values()) {
			listUnidades.add(uf.nome);
		}
	...
	/*
	 * Retorna lista de String com o capital das unidades
	 */
	public static List<String> listaCapitalUnidades(){
		List<String> listUnidades = new ArrayList<String>();
	
		for (final UnidadeFederativaEnum uf : UnidadeFederativaEnum.values()) {
			listUnidades.add(uf.capital);
		}
	...
	/*
	 * Retorna lista de Unidades com o sigla, nome e capital das unidades
	 */
	public static List<Unidades> listaUnidades(){
		List<Unidades> listUnidades = new ArrayList<Unidades>();
	
		for (final UnidadeFederativaEnum uf : UnidadeFederativaEnum.values()) {
			Unidades u = new Unidades();
			u.setNome(uf.nome);
			u.setCapital(uf.capital);
			u.setSigla(uf.sigla);
			listUnidades.add(u);
		}
	 ...
	 */
	public static UnidadeFederativaEnum fromSigla(final String sigla) {
		for (final UnidadeFederativaEnum uf : UnidadeFederativaEnum.values()) {
	 ...
	 */
	public static UnidadeFederativaEnum fromCapital(final String capital) {
		for (final UnidadeFederativaEnum uf : UnidadeFederativaEnum.values()) {
	...
	public String toString() {
		final StringBuilder sb = new StringBuilder("UnidadeFederativaEnum{");
